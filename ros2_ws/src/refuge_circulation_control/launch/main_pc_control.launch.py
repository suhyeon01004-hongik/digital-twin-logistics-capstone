...
def generate_launch_description():
    hardware_floor = LaunchConfiguration("hardware_floor")
    ...
    twin_floor = LaunchConfiguration("twin_floor")
    twin_render_dir = LaunchConfiguration("twin_render_dir")
    use_matlab_server = LaunchConfiguration("use_matlab_server")
    matlab_server_dir = LaunchConfiguration("matlab_server_dir")
    ...
    return LaunchDescription([
        DeclareLaunchArgument("hardware_floor", default_value="1"),
        ...
        DeclareLaunchArgument("twin_floor", default_value="1"),
        DeclareLaunchArgument("twin_render_dir", default_value="/tmp/refuge_twin_render"),
        DeclareLaunchArgument("use_matlab_server", default_value="true"),
        DeclareLaunchArgument("matlab_server_dir", default_value="/tmp/refuge_matlab_server"),
        ...
        Node(
            ...
            output="screen",
            parameters=[{
                "floor_id": ParameterValue(hardware_floor, value_type=int),
                "use_tof": ParameterValue(use_tof, value_type=bool),
                "tof_hard_gate": ParameterValue(tof_hard_gate, value_type=bool),
                "default_rpm": ParameterValue(default_rpm, value_type=float),
                "kp": ParameterValue(kp, value_type=float),
                "ki": ParameterValue(ki, value_type=float),
                "kd": ParameterValue(kd, value_type=float),
                "slowdown_mm": ParameterValue(slowdown_mm, value_type=float),
                "min_move_rpm": ParameterValue(min_move_rpm, value_type=float),
                "pwm_step": ParameterValue(pwm_step, value_type=int),
                "compact_reverse_rpm": ParameterValue(compact_reverse_rpm, value_type=float),
            }],
        ),
        Node(
            package="refuge_circulation_control",
            executable="digital_twin_compare",
            name="refuge_digital_twin_compare",
            output="screen",
            parameters=[{
                "work_dir": twin_work_dir,
                "floor_id": ParameterValue(twin_floor, value_type=int),
                "render_dir": twin_render_dir,
                "use_matlab_server": ParameterValue(use_matlab_server, value_type=bool),
                "matlab_server_dir": matlab_server_dir,
                "auto_min_hardware_move_mm": ParameterValue(auto_min_hardware_move_mm, value_type=float),
                "matlab_motion_only": ParameterValue(matlab_motion_only, value_type=bool),
                "receiver_gap_compact_enabled": ParameterValue(receiver_gap_compact_enabled, value_type=bool),
                "tof_correction_enabled": ParameterValue(tof_correction_enabled, value_type=bool),
                "tof_correction_step_mm": ParameterValue(tof_correction_step_mm, value_type=float),
                "tof_correction_max_mm": ParameterValue(tof_correction_max_mm, value_type=float),
                "tof_box_correction_max_mm": ParameterValue(tof_box_correction_max_mm, value_type=float),
                "tof_box_correction_margin_mm": ParameterValue(tof_box_correction_margin_mm, value_type=float),
                "tof_command_underrun_mm": ParameterValue(tof_command_underrun_mm, value_type=float),
                "tof_empty_extra_mm": ParameterValue(tof_empty_extra_mm, value_type=float),
                "tof_gap_prepare_step_mm": ParameterValue(tof_gap_prepare_step_mm, value_type=float),
                "tof_gap_prepare_max_mm": ParameterValue(tof_gap_prepare_max_mm, value_type=float),
                "b4_to_b1_handoff_adjust_mm": ParameterValue(b4_to_b1_handoff_adjust_mm, value_type=float),
                "platform_unload_drop_delta_mm": ParameterValue(platform_unload_drop_delta_mm, value_type=float),
                "manual_load_fast_rpm": ParameterValue(manual_load_fast_rpm, value_type=float),
                "manual_load_fast_overtravel_mm": ParameterValue(manual_load_fast_overtravel_mm, value_type=float),
                "manual_load_fast_short_belt_overtravel_mm": ParameterValue(
                    manual_load_fast_short_belt_overtravel_mm,
                    value_type=float,
                ),
                "manual_load_b1_extra_overtravel_mm": ParameterValue(
                    manual_load_b1_extra_overtravel_mm,
                    value_type=float,
                ),
                "manual_load_b2_extra_overtravel_mm": ParameterValue(
                    manual_load_b2_extra_overtravel_mm,
                    value_type=float,
                ),
                "manual_load_b4_extra_overtravel_mm": ParameterValue(
                    manual_load_b4_extra_overtravel_mm,
                    value_type=float,
                ),
                "manual_load_fast_burst_mm": ParameterValue(manual_load_fast_burst_mm, value_type=float),
                "manual_load_fast_burst_rpm": ParameterValue(manual_load_fast_burst_rpm, value_type=float),
                "manual_load_reverse_release_enabled": ParameterValue(
                    manual_load_reverse_release_enabled,
                    value_type=bool,
                ),
                "manual_load_reverse_release_sec": ParameterValue(manual_load_reverse_release_sec, value_type=float),
                "manual_load_reverse_release_rpm": ParameterValue(manual_load_reverse_release_rpm, value_type=float),
                "manual_load_empty_gap_tof_slack_mm": ParameterValue(manual_load_empty_gap_tof_slack_mm, value_type=float),
                "manual_load_b2_target_gap_extra_mm": ParameterValue(
                    manual_load_b2_target_gap_extra_mm,
                    value_type=float,
                ),
                "manual_load_b2_final_realign_underrun_mm": ParameterValue(
                    manual_load_b2_final_realign_underrun_mm,
                    value_type=float,
                ),
                "manual_load_b3_final_realign_underrun_mm": ParameterValue(
                    manual_load_b3_final_realign_underrun_mm,
                    value_type=float,
                ),
            }],
        ),
        Node(
            ...
            parameters=[{
                ...
                "twin_render_dir": twin_render_dir,
            }],
        ),
    ])
